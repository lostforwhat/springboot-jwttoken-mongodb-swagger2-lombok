...
//		public static String channel = "82";//渠道标识 
		public static String channel = "84";//渠道标识  单位开户
//		public static String appid = CryptoAes.encrypt("zhbapp82",encKey);//分配应用标识,需加密
		public static String appid = CryptoAes.encrypt("zhbapp84",encKey);//分配应用标识,需加密 单位开户
		...
		public static String send(String action, String buzType, String params, String paramValues){
			...
			System.out.println(headpara);
			//LogUtil.writeGjjLog(headpara);
			//System.out.println(headparaMD5);
			System.out.println(uploadmessage);
			//LogUtil.writeGjjLog(uploadmessage);
			...
			//LogUtil.writeGjjLog(realurl);
			//LogUtil.writeGjjLog(ret);
